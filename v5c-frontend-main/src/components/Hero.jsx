...
//         {content.headline}
//       </h1>
//       <p className="text-xs md:text-sm text-gray-400 mb-10 font-bold tracking-[0.1em] uppercase border-l-2 border-[#D4AF37] pl-6 max-w-3xl leading-relaxed font-sans">
//         {content.subHeadline}
//       </p>
