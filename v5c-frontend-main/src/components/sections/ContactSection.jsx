        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-start">
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4 phone-input-container">
                <PhoneInput
                  country={'ae'}
                  ...
                  inputClass="!w-full !bg-white !border !border-gray-300 !rounded-lg !px-4 !py-3 !text-[#0B1A2E] !placeholder-gray-500 !focus:border-[#D4AF37] !focus:outline-none !transition-colors !text-sm !font-sans !h-auto !pl-14"
                  buttonClass="!bg-white !border !border-gray-300 !rounded-l-lg hover:!bg-gray-50 transition-colors"
                  dropdownClass="!bg-white !border !border-gray-300 !rounded-lg !shadow-xl !font-sans !text-sm"
                  enableSearch={true}
