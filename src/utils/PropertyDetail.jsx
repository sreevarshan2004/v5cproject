              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <select
                      className="w-[100px] px-2 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-800 text-sm focus:outline-none focus:border-[#D4AF37] transition-all cursor-pointer"
                    ...
                    <input
                      ...
                      required
                      className="flex-1 px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-800 text-sm focus:outline-none focus:border-[#D4AF37] transition-all"
