            ...
            <div className="flex gap-2">
              <div className="w-[100px] shrink-0 relative">
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full bg-white border border-gray-200 rounded-lg pl-2 pr-6 py-2 text-[#0B1A2E] focus:border-[#D4AF37] focus:outline-none transition-colors text-xs font-sans appearance-none"
                >
                  <option value="">Code</option>
                  {countryCodes.sort((a, b) => a.name.localeCompare(b.name)).map((country, idx) => (
              ...
              <input
                ...
                onChange={handleChange}
                required
                className="flex-1 bg-white border border-gray-200 rounded-lg px-3 py-2 text-[#0B1A2E] placeholder-gray-400 focus:border-[#D4AF37] focus:outline-none transition-colors text-xs font-sans"
              />
            </div>
          </div>
        </div>
