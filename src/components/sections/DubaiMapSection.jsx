  ...
  return (
    <section id="map" className="py-24 md:py-40 bg-black border-t border-white/5 overflow-hidden font-sans">
      ...
      <div className="container mx-auto px-6 md:px-24 text-center mb-16 md:mb-24">
        <motion.span variants={fadeInUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="text-white text-[10px] font-black uppercase tracking-[0.8em] block mb-6">
          Location <span className="text-[#D4AF37]">Intelligence</span>
        </motion.span>
        <motion.h2 variants={fadeInUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="text-4xl md:text-5xl font-black uppercase text-white leading-snug tracking-tighter">
          {content.mapTitle}
        </motion.h2>
        ...
        <div className="lg:col-span-4 lg:order-1 flex flex-col">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="text-gray-400 text-xs md:text-sm leading-relaxed mb-10 font-sans">
                {selected.desc}
              </p>
